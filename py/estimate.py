with open('../ans/ex1_5_mutates_answer.txt', 'r') as f:
    l = f.readlines()
...
print(d)
arr = d
print(10*arr[0],2*arr[1],1*arr[2],1*arr[3],2*arr[4],10*arr[5])
arr = d

# l2_sum = 0;
# l2_avg = (105*arr[0]+15*arr[1]+5*arr[2]+3*arr[3]+3*arr[4]+5*arr[5]+15*arr[6]+105*arr[7])/50;
# print((105*arr[0],15*arr[1],5*arr[2],3*arr[3],3*arr[4],5*arr[5],15*arr[6],105*arr[7]))
